...
import LogoAnimated from "../../../assets/css/LogoAnimation.css";
              ...
              <div className={styles.singleWidget}>
                <div className={styles.logo}>
                  ...
                  <Link to={process.env.PUBLIC_URL + "/"}>
                    <img
                      src={footerBg === "white" ? logoDark : logo} width="250px"
                      alt="voip"
                    />
                  </Link>
                </div>
                <div className={styles.content}>
                  <p>
                    T-CUBE is an award-winning predictive AI model for tracking, predicting, and preventing the growth and exposure of disasters, pandemics, and epidemics.
                  </p>
                </div>
              </div>
            </div>
